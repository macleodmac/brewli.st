...
const SvgCoffeeBeanAlternative = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    xmlSpace='preserve'
    id='coffee-bean-alternative_svg__Ebene_1'
    x={0}
    y={0}
    viewBox='0 0 256 256'
    width='1em'
